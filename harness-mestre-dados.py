    ...
    def test_scenario_3_lgpd_pii_leakage_security(self):
        ...
        try:
            df_pii = pd.DataFrame({
                ...
                'email': ['cliente.exemplo@empresa-ficticia.com', 'cliente.secreto@empresa.com.br'],
            ...
            raw_email_present = ('cliente.exemplo@empresa-ficticia.com' in masked_df['email'].values)
